...
<div align="center">
    <strong>
        ...
        Kết quả cấp phép<br/>
        <?php
        if (isset($license_type_name)):
            echo '"' . $license_type_name . '"<br/>';
        endif;
        ?>
        <?php
        if ($year):
...
<table border="1" cellpadding="4" cellspacing="0" width="500">
    <tbody>
        <tr>
            <td width="7%" align="center"><strong>STT</strong></td>
            <td width="33%" align="center"><strong>Tên loại giấy phép</strong></td>
            <td width="30%" align="center"><strong>Người đăng ký</strong></td>
            <td width="15%" align="center"><strong>Số giấy phép</strong></td>
            <td width="15%" align="center"><strong>Ngày cấp phép</strong></td>
        </tr>
        <tr>
        ...
        <?php foreach ($arr_all_record as $record): ?>
            <tr>
                ...
                <td><?php echo $record['C_CITIZEN_NAME'] ?></td>
                <td><?php echo $record['C_LICENSE_NO'] ?></td>
                <td align="center"><?php echo date_format(new DateTime($record['C_ISSUED_DATE']), 'd/m/Y') ?></td>
            </tr>
        <?php endforeach; ?>
    </tbody>
</table>
