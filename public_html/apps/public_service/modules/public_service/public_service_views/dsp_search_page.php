...
$v_record_type_code  = isset($v_record_type_code) ? $v_record_type_code : '';
$arr_all_record      = isset($arr_all_record) ? $arr_all_record : array();
    ...
    <form class="form-horizontal" name="frmMain" id="frmMain" action="" method="post"  >
        ...
        <div id="page-search" class="span12" >
            <!--End #box-chart-->
                ...
                <div class="content-widgets light-gray span6">
                    <div class="widget-head blue">
                        <h3>Tra cứu</h3>
                    </div>
                    <!--End .widget-head blue-->

                    <div class="widget-container" style="border: 1px solid rgb(52, 152, 219);border-top: 0">
                        <div class="widget-container" style="min-height: 90px; margin-top: 20px " id="filter">
                            <div class="Row">
                                <div class="left-Col">
                                    <label> Mã hồ sơ: </label>
                                </div>
                                <div class="right-Col" style="width: auto">
                                    <input type="text" style="width: 250px" name="txt_record_no" onchange="$(this).val($(this).val().toUpperCase());"
            ...
            <div class="row-fluid" id="search-results">
                <div class="span12">              
                    <div id="procedure">
                        <!--Hien thi chi tiet ho so tim thay-->
                        <?php 
                            $arr_single_record    = isset($VIEW_DATA['resluts_filter']['arr_single_record']) ? $VIEW_DATA['resluts_filter']['arr_single_record'] : array();
                            if (!isset($arr_single_record['PK_RECORD']) || trim($arr_single_record['PK_RECORD'])  == ''):
                                
                                    echo ($v_record_no != '') ?  "<div class='box-message'><h4 style=''>Mã hồ sơ \" $v_record_no \" bạn cần tìm không chính xác xin vui lòng kiểm tra lại!</h4></div>" : '';
                            else:
                            
                                $arr_all_doc          = $VIEW_DATA['resluts_filter']['arr_all_doc'];
                                $arr_step_formal_date = $VIEW_DATA['resluts_filter']['arr_step_formal_date'];
                            ...
                            ?>
                                ...
                                <div class="group" style="padding-bottom: 5px; float: left;width: 100%">
                                    <div class="widget-head blue">
                                            <h3>
                                                Thông tin chi tiết hồ sơ :&nbsp; <?php echo $v_record_no ;?>
                                            </h3>
                                    </div>
                            ...
                            <script>
                                ...
                                $(document).ready(function() {
                                    ...
                                    $('#procedure *').attr('disabled','disabled');
                                    $('#btnDate').hide();
