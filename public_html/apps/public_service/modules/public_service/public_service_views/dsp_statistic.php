                        ...
                        <div class="content-widgets light-gray">
                            ...
                            <div id="box-chart" class="widget-container" >
                                ...
                                <div class="span2" id="chart-type">
                                    <!--button pie chart-->
                                    <button class="btn btn-danger" type="button"  data="pie" onclick="show_chart_onclick(this)">
                                        <i class="icon-bar-chart"></i>
                                        Tiến độ xử lý hồ sơ
                                    </button>
                                    <div class="clear" style="height: 5px;"></div>
                                    <!--button bar chart-->
                                    <button class="btn btn-info" type="button" data="bar"  onclick="show_chart_onclick(this)">
                                        <i class="icon-bar-chart"></i>
