...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template name="create_handover_info">
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			...
			<tr>
				<td>
					<strong>Số lượng bản:</strong>
				</td>
				<td>
                    <xsl:value-of select="//item[@id='txtSoLuongBanSao']/value" disable-output-escaping="yes"/>
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
                    <xsl:if test="//item[@id='txtCost']/value !=''">
                        <xsl:value-of select="//item[@id='txtCost']/value" disable-output-escaping="yes"/>đ
                    </xsl:if>
				</td>
			</tr>
		</table>
