	...
	<xsl:template name="create_handover_info">
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%" class="header">
			...
			<tr>
				<td colspan="2" class="report-title">
					<span class="title-1">GIẤY BIÊN NHẬN HỒ SƠ</span>
					<br/>
					<span>
						<strong>Mã hồ sơ:</strong>
						<xsl:value-of select="$v_record_no" disable-output-escaping="yes"/>
					</span>
					<br/>
					<span class="title-2">
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			...
			<tr>
				...
				<td>
					<xsl:value-of select="//item[@id='txtNguyenQuan2']/value" disable-output-escaping="yes"/>
				</td>
			</tr>
			<tr>
				<td>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="C_XML_DATA7.xml" htmlbaseurl="" outputurl="" processortype="saxon8" useresolver="yes" profilemode="0" profiledepth="" profilelength="" urlprofilexml=""
	...
	<MapperMetaTag>
		<MapperInfo srcSchemaPathIsRelative="yes" srcSchemaInterpretAsXML="no" destSchemaPath="" destSchemaRoot="" destSchemaPathIsRelative="yes" destSchemaInterpretAsXML="no">
			<SourceSchema srcSchemaPath="C_XML_DATA7.xml" srcSchemaRoot="data" AssociatedInstance="" loaderFunction="document" loaderFunctionUsesURI="no"/>
		</MapperInfo>
		<MapperBlockPosition>
			<template match="/">
				<block path="html/body/xsl:value-of" x="375" y="72"/>
				<block path="html/body/div/table/tr[2]/td/p/xsl:value-of" x="375" y="64"/>
				<block path="html/body/div/xsl:call-template" x="415" y="90"/>
				<block path="html/body/div/table[1]/tr[2]/td/p/xsl:value-of" x="415" y="181"/>
				<block path="html/body/div/xsl:call-template[1]" x="335" y="90"/>
			</template>
		</MapperBlockPosition>
