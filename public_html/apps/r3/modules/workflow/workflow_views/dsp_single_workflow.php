<?php
/**
// File name   : dsp_single_workflow.php
// Version     : 1.0.0.1
// Begin       : 2012-12-01
...
?>
    ...
    <div id="procedure">
                    ...
                    <table width="100%" border="1" width="100%">
                        ...
                        foreach ($steps as $step):
                            ...
                            foreach ($tasks as $task):
                                $t++;
                                $v_task_code = $task->attributes()->code;
                                ...
                                {
                                    $v_prev_step_last_task = $dom->xpath("//step[task[@code='$v_task_code']]/task[position()=1]/@code");
                                    $v_prev_step_last_task = $v_prev_step_last_task[0];
                                }
                                ...
                                <tr>
                                    <?php if ($t == 1): ?>
                                        <td rowspan="<?php echo $v_rows; ?>"><?php echo $v_step_name; ?><br><i>(<?php echo $v_step_time ?> ngày làm việc)</i></td>
                                    <?php endif; ?>
        ...
        <?php else: ?>
            ...
            <br/>Hãy <input type="button" name="btn_add_workflow" onclick="btn_edit_workflow_onclick(this)" class="button add" value="Tạo quy trình" />
        <?php endif; ?>
    </div>
