...
<html>
    ...
    <body contenteditable>
        ...
        <div>
            ...
            <?php create_handover_info($report_data, '(Liên 2: Giao cho phòng chuyên môn)', $v_xml_ho_for_bu_template_file);?>
        </div>
    </body>
</html>
<?php
function create_handover_info($report_data, $distribute = '(Liên 1: Lưu)', $v_xml_ho_for_bu_template_file)
{
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="header">
        ...
        <tr>
            <td colspan="2" class="report-title">
                <span class="title-1">GIẤY BÀN GIAO HỒ SƠ ĐÃ BỔ SUNG <br/>CHO PHÒNG CHUYÊN MÔN</span><br/>
    ...
    <table cellpadding="0" cellspacing="0" width="100%" >
        ...
        <tr>
            ...
            <td>
                <?php echo $arr_single_task_info['C_RECEIVE_HO_GROUP_NAME'];?>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            ...
            <td>
                ...
                <?php echo get_request_var('record_type_name');?>
            </td>
        </tr>
        <tr>
            <td>
