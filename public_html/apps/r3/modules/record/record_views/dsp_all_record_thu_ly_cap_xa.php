...
<script>
    $(document).ready( function() {
        ...
        //Quick action
        <?php if (strtoupper($this->active_role) == _CONST_THU_LY_CAP_XA_ROLE): ?>
    ...
    {
        var url = '<?php echo $this->get_controller_url();?>dsp_exec_by_village/' + record_id
    ...
    function btn_dsp_exec_onclick()
    {
        ...
        {
            var url = '<?php echo $this->get_controller_url();?>dsp_exec_by_village/' + v_selected_record_id_list
                + '/?record_type_code=' + $("#record_type_code").val()
                + '&pop_win=1';
