...
?>
<form name="frmMain" method="post" id="frmMain" action="<?php echo $this->get_controller_url(); ?>do_submit_to_sign_record">
    <?php
    ...
    <?php echo $this->hidden('rad_approval',_CONST_RECORD_APPROVAL_ACCEPT);?>
