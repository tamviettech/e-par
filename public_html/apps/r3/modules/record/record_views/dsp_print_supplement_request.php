            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" class="header">
                ...
                <tr>
                    <td colspan="2" class="report-title">
                        <span class="title-1">PHIẾU ĐỀ NGHỊ BỔ SUNG HỒ SƠ</span><br/>
                    </td>
                </tr>
            </table>
            <!-- Message -->
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td colspan="2" class="center">
                        <b><u>Chuyển đến:</u></b><i> Bộ phận Một cửa</i>
                    </td>
                </tr>
                <tr>
                    <td>
                        <script>
                            ...
                            w(parent.$("#hdn_approving_group_name").val() + ' trả lại hồ sơ cho Bộ phận Một cửa để bổ sung.'); 
                            w('<br/><br/>'); 
                ...
                <tr>
                    <td>
                        ...
                        <script>
                            ...
                            $('#box-slimscroll').css('height','auto');
                        </script>
                    </td>
                </tr>
                <tr>
