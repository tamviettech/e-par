    ...
    $(function() {
        <?php if (strtoupper($this->active_role) == _CONST_TIEP_NHAN_ROLE): ?>
            $('.adminlist tr[role="presentation"] td[role="action"] .quick_action').each(function(index) {
                ...
                //Delete
                //html = '<a href="javascript:void(0)" onclick="quick_delete_item(\'' + v_item_id + '\')">'
                //html += '<img src="' + SITE_ROOT + 'public/images/icon_delete.png" title="Xoá hồ sơ" class="quick-action"></a>';
