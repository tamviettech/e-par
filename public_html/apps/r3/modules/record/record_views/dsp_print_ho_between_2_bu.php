...
$report_data = array(
    ...
    ,'arr_group_info'             => $VIEW_DATA['arr_group_info']
);
...
function create_handover_info($report_data, $distribute = '(Liên 1: Lưu)', $v_xml_ho_for_bu_template_file)
{
    ...
    $arr_group_info         = $report_data['arr_group_info'];
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="header">
        ...
        <tr>
            <td colspan="2" class="report-title">
                <span class="title-1">GIẤY BÀN GIAO HỒ SƠ<br/>GIỮA CÁC PHÒNG CHUYÊN MÔN</span><br/>
    ...
    <table cellpadding="0" cellspacing="0" width="100%" >
        ...
        <tr>
            ...
            <td>
                <?php echo $arr_group_info['C_CURRENT_GROUP_NAME'];?>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <?php echo $arr_group_info['C_NEXT_GROUP_NAME'];?>
            </td>
        </tr>
        <tr>
            <td>
