...
<script>
    ...
    $(function() {
        ...
        //Quick action
        <?php if (strtoupper($this->active_role) == _CONST_KY_ROLE): ?>
    ...
    function btn_sign_onclick(record_id)
    {
        ...
        {
            var url = '<?php echo $this->get_controller_url();?>dsp_sign/' + v_selected_record_id_list
