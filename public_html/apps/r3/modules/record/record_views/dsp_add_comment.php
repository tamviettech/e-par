...
if(Session::get('add_comment_token') == NULL)
{
...
<form name="frmMain" id="frmMain" method="POST" action="<?php echo $this->get_controller_url();?>do_add_comment">
    <?php 
        ...
        echo $this->hidden('add_comment_token',Session::get('add_comment_token'));
    ?>
    ...
    <div class="button-area">
        <!--button update-->
        <button type="button" name="btn_do_add_comment" class="btn btn-primary" onclick="btn_do_add_comment_onclick();" accesskey="2">
            <i class="icon-save"></i>
