<?php 
/**
// File name   : dsp_single_record_statistics.php
// Version     : 1.0.0.1
// Begin       : 2012-12-01
...
//echo __FILE__ . '<br>Line: ' . __LINE__; var_dump::display($arr_single_record);
//display header
    ...
    <div id="tabs_statistics">
                    ...
                    foreach ($steps as $step):
                        ...
                        <tr data-step_order="<?php echo $step_order;?>">
                            ...
                            <td rowspan="<?php echo $v_rows;?>" class="center" id="step_begin_date_<?php echo $step_order;?>">
                                <?php echo ($v_flow_total_time >=0) ? jwDate::yyyymmdd_to_ddmmyyyy(@$arr_step_formal_date[$step_order]['C_BEGIN_DATE'], 1) : '';?>
                            </td>
                            ...
                            <td rowspan="<?php echo $v_rows;?>" id="step_end_date_<?php echo $step_order;?>">
                                <?php echo ($v_flow_total_time >=0) ? @$this->return_date_by_text(@$arr_step_formal_date[$step_order]['C_END_DATE']) : '';?>
                            </td>
        ...
        <div id="comment">
            <table id="tbl_comment" cellpadding="0" cellspacing="0" border="1" width="100%">
                ...
                <?php for ($c=0; $c<sizeof($arr_all_comment); $c++):
            ...
            <table class="adminlist" cellpadding="0" cellspacing="0" width="100%">
                ...
                <?php foreach($steps as $step): ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo $this->role_text[$v_role];?>
                        </td>
                        <td>
...
<script>
    $(document).ready(function() {
        ...
        tab_statistics.tabs('select', '<?php echo $_GET['tab'];?>');
        <?php endif; ?>
