...
<form name="frmMain" id="frmMain" action="" method="POST">
    ...
    <div id="solid-button">
        <input type="button" class="solid approval" value="Trình ký"
...
<script>
    $(document).ready( function() {
        ...
        <?php if (strtoupper($this->active_role) == _CONST_XET_DUYET_ROLE): ?>
            $('.adminlist tr[role="presentation"] td[role="action"] .quick_action').each(function(index) {
                ...
                html += '<img src="' + SITE_ROOT + 'public/images/approve-16x16.png" title="Trình ký" /></a>';
    ...
    function btn_dsp_approval_onclick(record_id)
    {
        ...
        {
            var url = '<?php echo $this->get_controller_url();?>dsp_submit_to_sign/' + v_selected_record_id_list
