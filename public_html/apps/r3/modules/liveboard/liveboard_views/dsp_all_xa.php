...
<script type="text/javascript">
    function build_col_width() {
        ...
        html[++i] = '<col width="' + arr_cw[8] + '"/>';
        html[++i] = '<col width="' + arr_cw[5] + '"/>';
...
<script>
            ...
            {
                var url = '<?php echo $this->get_controller_url(); ?>dsp_all_xa_liveboard';
