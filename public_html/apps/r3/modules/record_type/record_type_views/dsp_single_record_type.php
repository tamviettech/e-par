<?php 
/**
// File name   : dsp_single_record_type.php
// Version     : 1.0.0.1
// Begin       : 2012-12-01
...
<form name="frmMain" method="post" id="frmMain" action=""><?php
    ...
    <div class="Row">
        ...
        <div class="right-Col">
            ...
            <br/>
            <input type="checkbox" name="chk_send_over_internet" value="1"
                <?php echo ($v_send_over_internet > 0) ? ' checked' : ''; ?>
                id="chk_send_over_internet"
            /><label for="chk_send_over_internet"><?php echo __('send over internet'); ?></label><br/>
