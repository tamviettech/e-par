...
<div class="container-fluid">
    <div class="row-fluid ">
        ...
        if (isset($arr_single_record_type['PK_RECORD_TYPE']))
        {
            ...
            $v_is_endless = $arr_single_record_type['C_IS_ENDLESS'];
        }
        else
        {
            $v_record_type_id      = 0;
                ...
                <div class="widget-container">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <div class="alert">
                                <label>
                                    <input type="checkbox" name="chk_is_endless" value="1" <?php echo ($v_is_endless > 0) ? ' checked' : ''; ?>>Thủ tục không xác định thời hạn
                    ...
                    <div class="form-actions">
                        ...
                        <button type="button" name="btn_view_workflow" class="btn" onclick="window.open('<?php echo $this->get_controller_url('workflow'); ?>' + QS + 'sel_record_type=<?php echo $v_code; ?>');"><i class="icon-search"></i>Xem quy trình xử lý hồ sơ</button>
                        <button type="button" name="btn_view_form" class="btn" onclick="btn_dsp_plaintext_form_struct_onclick()"><i class="icon-search"></i>Xem biểu mẫu đơn</button>
                        <?php
                        if (intval($v_record_type_id) > 0)
                        {
                            echo '<button type="button" name="btn_view_workflow" class="btn" onclick="window.open(\'' . SITE_ROOT . 'guidance/guidance/dsp_single_guidance/' . $v_record_type_id . '\');"><i class="icon-search"></i>Xem thông tin hướng dẫn tại cổng thông tin</button>';
                        }
                        ?>
                        ...
                        <div class="controls">
                            <div id="container_trinh_tu_thuc_hien">
                                <textarea id="txta_trinh_tu_thuc_hien" name="txta_trinh_tu_thuc_hien" class="span6"  
                                          data-allownull="yes" data-validate="text"
                                          data-name="Phí, lệ phí"
                                          data-xml="yes" data-doc="no" ><?php echo $v_trinh_tu_thuc_hien;
                        ; ?></textarea>
                            </div>
                        </div>
                    </div>
