...
if ($v_direction == 'VBDEN')
{
    ...
    $v_thead = '<tr><td colspan="1000"><table border="1" cellpadding="2" cellspacing="0">';
...
elseif ($v_direction == 'VBDI')
{
    ...
    $v_cont_page_head = '<tr>';
    $v_cont_page_head .= '<td width="' . $arr_vbdi_column_width['so_ky_hieu'] . '" align="center"><i>(1)</i></td>';
    $v_cont_page_head .= '<td width="' . $arr_vbdi_column_width['ngay_di'] . '" align="center"><i>(2)</i></td>';
    ...
    for ($i=0; $i<$v_count_doc; $i++)
    {
        ...
        $r = $dom_xml_data->xpath("/data/item[@id='doc_ngay_di']/value");
