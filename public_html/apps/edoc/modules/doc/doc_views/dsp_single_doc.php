...
<form name="frmMain" method="post" id="frmMain" action="#" enctype="multipart/form-data"><?php
    ...
    <!-- Cot tuong minh -->
    <div class="Row">
        <div class="left-Col">Sổ văn bản <span class="required">(*)</span> </div>
        <div class="right-Col">
    ...
    <div class="Row">
        ...
        <div class="right-Col">
            ...
            ?>
            <input type="file" style="border: solid #D5D5D5; color: #000000" class="multi accept-<?php echo _CONST_RECORD_FILE_ACCEPT; ?>"  
                   name="uploader[]" id="File1" accept="<?php echo '.' . str_replace(',', ',.', _CONST_RECORD_FILE_ACCEPT) ?>"/>
            <font	style="font-weight: normal;">Hệ thống chỉ chấp nhận đuôi file dạng:</font>
            <span class="fileUploaderMessage"> <?php echo _CONST_RECORD_FILE_ACCEPT ?></span>
        </div>
    </div>
    <?php
    //Dynamic XML
    ...
    <div class="button-area">
        ...
        <?php if ($v_is_granted_update): ?>
            <a href="javascript:;" onclick="btn_update_onclick();" class="easyui-linkbutton" iconCls="icon-save">
...
<?php if ($v_direction == 'VBDI'): ?>
    <?php if (!$this->check_permission('VAO_SO_VAN_BAN_DI')): ?>
