...
<body>
	...
	<p>
		Hôm nay, ngày <?php echo Date('d');?>/<?php echo Date('m');?>/<?php echo Date('Y');?>, tại Trụ sở Tiếp công dân tỉnh, ông Hà Hoà
		Bình - Phó Chủ tịch UBND tỉnh chủ trì ngày tiếp công dân định kỳ theo
		quy định; cùng tham dự có các Sở, ngành liên quan đã tiếp:
