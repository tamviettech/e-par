...
class adLDAP {
    ...
    * @var string
    */
	protected $accountSuffix = AD_ACCOUNT_SUFFIX;
    ...
    * @var array
    */
    protected $domainControllers = array(AD_DC_LIST);
    ...
    * @var string
    */
	protected $adminUsername = AD_ADMIN_USER;
    protected $adminPassword = AD_ADMIN_PASSWORD;
